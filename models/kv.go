...
func (o *KV) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for kv")
	}
...
func (o *KV) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for kv")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for kv")
	}
