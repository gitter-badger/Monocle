...
type Alliance struct {
	...
	ExecutorCorporationID uint      `boil:"executor_corporation_id" json:"executor_corporation_id" toml:"executor_corporation_id" yaml:"executor_corporation_id"`
...
func (o *Alliance) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for alliances")
	}
...
func (o *Alliance) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for alliances")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for alliances")
	}
